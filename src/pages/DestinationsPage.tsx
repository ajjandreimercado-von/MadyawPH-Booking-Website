    ...
    <div className="min-h-screen bg-brand-background pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <section className="bg-brand-cream border border-brand-primary/10 rounded-[2rem] p-8 sm:p-10 shadow-md">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-brand-dark/60">Destinations</p>
          <h1 className="mt-3 text-3xl sm:text-4xl font-serif font-bold text-brand-dark">Discover Our Destination Collection</h1>
